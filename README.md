...
* **Storage Sink**: Telegram Bot API (cloud document and message storage)
* **Process**: Single-process daemon with automatic reconnection handling

## Security Policy

Security issues should be reported privately to `goharrehmanfsd260@gmail.com`.
...
Proprietary. All rights reserved. For private operational use only.
